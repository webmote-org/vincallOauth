...
namespace Vincall.OauthService.Middleware
{
    public class TokenRequestValidator : ITokenRequestValidator
    {
        ...
        private TokenRequestValidationResult ValidateAuthorizationCodeWithProofKeyParameters(string codeVerifier, AuthorizationCode authZcode)
        {
            ...
            //if (OAuthConstants.CodeChallengeMethods.SupportedMethods.Contains(authZcode.CodeChallengeMethod) == false)
            //{
    ...
    {
        public static bool IsMissing(this string source) => string.IsNullOrWhiteSpace(source);
        public static bool IsPresent(this string source) => !string.IsNullOrWhiteSpace(source);
        public static List<string> ParseScopesString(this string scopes)
        {
            ...
            scopes = scopes.Trim();
            var parsedScopes = scopes.Split(new[] { ' ' }, System.StringSplitOptions.RemoveEmptyEntries).Distinct().ToList();
